...
class Ajax_Handler {
	...
	/**
	 * Add all the ajax endpoints to WordPress
	 *
	 * @param boolean $init Register or not the ajax end points.
	 */
	...
	/**
	 * Return the data from the API or cache
	 *
	 * @param boolean $no_ajax // Avoid returning a json respond and just return the array.
	 * @return array
	 */
	...
	public function refresh_data() {
		...
		// phpcs:disable
		// No need of nonce for this case.
		if ( isset( $_POST['ajax'] ) ) {
